...
/**
 * This is the interface which specifies all the methods for a Regression algorithm
 * @author low101043
 *
 */
public interface Regression {
	 ...
	 * @param polynomialSize The polynomial size to use or the number of independent values to use
	 */
