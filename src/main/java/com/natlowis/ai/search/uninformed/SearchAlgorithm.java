...
public interface SearchAlgorithm {
	...
	/**
	 * This will give the nodes to visit for the solution which has been found by that algorithm
	 ...
	 * @return 2D array with the connections to visit from the start node to the end node
	 */
